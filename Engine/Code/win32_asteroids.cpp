...
Win32LoadGameCode(char *SourceDLLName)
{
    ...
    //char *TempDLLName = "D:/Game/OwnProjects/Asteroids/build/asteroids_temp.dll";
...
struct platform_work_queue
{
    ...
    platform_platform_work_queue_entry Entries[8];
};
        ...
        int ShowCode)
{
    ...
    int ScreenDimensionX = 960;
    int ScreenDimensionY = 540;
    ...
    if(RegisterClassA(&WindowClass))
    {
        ...
        if(Window)
        {
            ...
            //char *SourceDLLName = "D:/Game/OwnProjects/Asteroids/build/asteroids.dll";
