...
#define Hi4i(m) *(((__m128i *)&m) + 1)
            ...
            X += 4)
        {
                ...
                Y += 2)
            {
                ...
                //__m256
                //__m128i WriteMask0 = _mm_setr_epi32();
                //__m128i WriteMask1 = _mm_setr_epi32();
                ...
                //PixelPos = _mm256_setr_epi32(0,1,2,3,0+Buffer->Pitch,1+Buffer->Pitch,2+Buffer->Pitch,3+Buffer->Pitch);
                ...
                if(M(PixelDistance, 0) > 1.0f)
                {
                    u32 asd = 5;
                }
                
                if(M(PixelDistance, 0) < 0.0f)
                {
                    u32 asd = 5;
                }
                
                PixelDistance = _mm256_max_ps(_mm256_min_ps(PixelDistance, Ones), Zeroes);
                ...
                if((M(PixelDistance, 0) >= 0.0f) && (M(PixelDistance, 0) < 1.0f))
                {
                    u32 asd = 5;
                }
                ...
                __m256i asd01 = _mm256_cvtps_epi32(Texel01);
                __m256i asd23 = _mm256_cvtps_epi32(Texel23);
                __m256i asd45 = _mm256_cvtps_epi32(Texel45);
                __m256i asd67 = _mm256_cvtps_epi32(Texel67);
                
                __m256i shift0 = _mm256_slli_epi32(asd01, 0);
                __m256i shift1 = _mm256_slli_epi32(asd23, 8);
                __m256i shift2 = _mm256_slli_epi32(asd45, 16);
                __m256i shift3 = _mm256_slli_epi32(asd67, 24);
                ...
                //_mm_storeu_si128((__m128i *)Ptr0, _mm256_castsi256_si128(temp1));
                //_mm_storeu_si128((__m128i *)Ptr1, _mm256_castsi256_si128(temp2));
